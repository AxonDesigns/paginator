...
import { appendAreaFillGradient, svgEl, svgText } from './chart-render.ts'
...
export function renderCategoricalChart(svg: SVGSVGElement, node: CategoricalChartNode, plot: Box): void {
