...
const printModeCleanups = new WeakMap<HTMLElement, () => void>()
...
export function mount(result: PaginatedResult, host: HTMLElement): void {
  ...
  const onBeforePrint = (): void => applyPrintMode(wrapper, pageEls, true)
  const onAfterPrint = (): void => applyPrintMode(wrapper, pageEls, false)
