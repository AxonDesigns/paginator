...
const registryInstanceIds = new WeakMap<FontRegistry, number>()
let nextRegistryInstanceId = 0
let nextAliasSequence = 0

function nextAliasFor(registry: FontRegistry): string {
...
let activeFontRegistry: FontRegistry | null = null
...
export function withActiveFontRegistry<T>(registry: FontRegistry, fn: () => T): T {
 ...
 */
export function resolveFontFamilyForRendering(
  registry: FontRegistry | null,
  fontFamily: string,
  weight: number | string | undefined,
  style: FontStyle | undefined,
): string {
  if (registry === null) return fontFamily
...
export function resolveActiveFontFamily(fontFamily: string, weight: number | string | undefined, style: FontStyle | undefined): string {
