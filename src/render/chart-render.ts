...
import { renderCategoricalChart } from './chart-render-categorical.ts'
import { renderRadialChart } from './chart-render-radial.ts'
import { renderScatterChart } from './chart-render-scatter.ts'
import { renderGanttChart } from './chart-render-gantt.ts'
import { renderRadarChart } from './chart-render-radar.ts'
import { renderCandlestickChart } from './chart-render-candlestick.ts'
...
export function appendAreaFillGradient(svg: SVGSVGElement, axis: 'x' | 'y', from: number, to: number, color: string, opacity: number): string {
...
function renderLegend(svg: SVGSVGElement, entries: LegendEntry[], box: ChartBox, orientation: 'vertical' | 'horizontal', fontSize: number, fontFamily: string, color: string): void {
  const swatch = 10
