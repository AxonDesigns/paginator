...
import { AXIS_COLOR, BAR_MAX_THICKNESS, CANDLESTICK_DOWN_COLOR, CANDLESTICK_UP_COLOR, CHART_FONT_FAMILY, GRIDLINE_COLOR, INK_MUTED, MARK_SURFACE_GAP, candlestickGeometry, estimateChartTextWidth, niceTickValues, resolveDomainFromExtent, textBaselineOffset, } from "./chart-geometry.js";
import { svgEl, svgText } from "./chart-render.js";
export function renderCandlestickChart(svg, node, plot) {
