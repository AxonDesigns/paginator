...
import { AXIS_COLOR, CHART_FONT_FAMILY, GRIDLINE_COLOR, INK_MUTED, MARKER_RADIUS, SURFACE_COLOR, estimateChartTextWidth, niceTickValues, resolveBubbleRadius, resolveColor, resolveDomainFromExtent, resolveMarkerRadii, textBaselineOffset, } from "./chart-geometry.js";
import { svgEl, svgText } from "./chart-render.js";
export function renderScatterChart(svg, node, plot) {
