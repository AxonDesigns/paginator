...
import { AXIS_COLOR, BAR_MAX_THICKNESS, CANDLESTICK_DOWN_COLOR, CANDLESTICK_UP_COLOR, CHART_FONT_FAMILY, GRIDLINE_COLOR, INK_MUTED, MARK_SURFACE_GAP, barPath, candlestickGeometry, estimateChartTextWidth, niceTickValues, resolveDomainFromExtent, textBaselineOffset, } from "../../render/chart-geometry.js";
import { drawChartLine, drawChartPath, drawChartText } from "./pdf.js";
export function drawCandlestickChart(ctx, node, plot, originX, originY) {
