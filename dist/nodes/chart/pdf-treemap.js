...
import { CHART_FONT_FAMILY, MARK_SURFACE_GAP, SURFACE_COLOR, barPath, estimateChartTextWidth, normalizeChartText, resolveColor, squarifyTreemap } from "../../render/chart-geometry.js";
import { drawChartPath, drawChartText } from "./pdf.js";
export function drawTreemapChart(ctx, node, plot, originX, originY) {
